...
def create_unit_pointset_from_hdf5(f, n_max_instances, noisy, fixed_order=False, check_only=False, shuffle=True):
    '''
        f will be a h5py group-like object
    '''

    P_h5 = f['data'][()] if noisy else f['gt_points'][()]  # Nx3
    P = P_h5[:, 0:3]
